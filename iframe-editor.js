...
$.Editor=(function(){
	...
	$.extend(qeditor.prototype,{
		...
		geturl: function(str){
			...
			url.push('<style type="text/css"> * { margin: 0; padding: 0; } html,body{height: 100%;} ul, ol {padding-left: 30px;} body.editormode { font-size: 13px; line-height: 150%; font-family: \'宋体\',Arial}</style>');
		...
		build: function(){
			...
			this.autowidth=(this.key.width()-14)||'auto';
			
			this.panel=$('<div class="qeditor"></div>').width(this.autowidth);
